...
export default function CarModal({ setModal, fetchCars, modal }) {
  return (
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <div className="flex items-center justify-between">
              ...
              <XCircle
                ...
                onClick={() => setModal({ car: null, open: false })}
              />
            </div>
            <CarForm setModal={setModal} modal={modal} fetchCars={fetchCars} />
          </div>
        </div>
      </div>
    </div>
